...
//        mapWithCoordinates = prepareToInsertInMap(x, y, "demo server");
        mapWithCoordinates = prepareToInsertInMap(x, y, Display_Const.block_serverIp_title + User_Fields.get_serverIp());
        addToDisplay(mapWithCoordinates);
        ...
        mapWithCoordinates = prepareToInsertInMap(x, y, Display_Const.block_serverPort_title + serverPort);
        addToDisplay(mapWithCoordinates);
    }
